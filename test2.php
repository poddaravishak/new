                    ...
                    <div class="post-upload-T">
                        ...
                        if (mysqli_num_rows($post_result) > 0) {
                            ...
                            while ($post_row = mysqli_fetch_assoc($post_result)) {
                                ...
                                echo '<div class="box-design post-div">';
                                echo '<div class="post-infarmation">';
                                echo '<div>';
                                echo '<div class="profil-ing-div post-profile-img">';
                                echo '<a href="#" id="profile-link">';
                                echo '<img id="Profile_images" src="' . $photo . '" />';
                                echo '</a>';
                                echo '</div>';
                                echo '</div>';
                                echo '<div class="post-three-dot">';
                                echo '<h2><a href="#" id="profile_name">' . $first_name . '</a></h2>';
                                echo '<p><a href="%">date </a></p>';
                                echo '<span class="thre-dto-btn fas fa-ellipsis-h"></span>';
                                echo '</div>';
                                echo '</div>';
                                echo '<input type="text" id="first_name" name="first_name" value="' . $student_id . '" style="display: none;">';
                                echo '<p class="post-text-show">' . $post_content . '</p>';
                                echo '<div class="comment-site">';
                                echo '<div class="profil-ing-div">';
                                echo '<a href="#" id="profile-link">';
                                echo '<img id="Profile_images" src="images/friends/00.jpg" />';
                                echo '</a>';
                                echo '</div>';
                                echo '<div class="comment-input">';
                                echo '<input type="text" placeholder="Write a comment…" />';
                                echo '</div>';
                                echo '</div>';
                                echo '</div>';
                            }
